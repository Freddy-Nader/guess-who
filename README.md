<div align="center">
  <img src="img/logo.png" width="128" alt="Adivina Quién Logo">

  # Guess Who?
  *Classic board game [Guess Who?](https://en.wikipedia.org/wiki/Guess_Who%3F), written in [Gambas](https://gambaswiki.org/)*

  [![License](https://img.shields.io/badge/MIT%20License-00AA00?style=flat-square)](LICENSE)
  ...
  [Spanish Version](https://github.com/Freddy-Nader/guess-who/tree/master) • [Features](#features) • [Getting Started](#getting-started) • [License](#license)

  <br />

  <img src="assets/banner.jpeg" alt="Adivina Quién Banner" width="80%">
...
You must have **Gambas 3** installed to execute this project. Visit the [Gambas website](https://gambaswiki.org/website) for detailed download and installation instructions.
